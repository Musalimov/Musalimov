...
| **[UOWD Tutorial Availability Checker](https://github.com/Musalimov/UOWD-Tutorial-Availability-Checker)** | A Selenium-based automation tool that monitors UOWD tutorial slot availability, detects status changes, and sends Telegram notifications when a selected slot becomes available.          | Python / Selenium / Telegram Bot / Web Automation       |
